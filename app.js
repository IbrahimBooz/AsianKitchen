...
const allBtn = document.getElementById('allValue');
const koreaBtn = document.querySelector('[data-id="Korea"]');
const ChinaBtn = document.querySelector('[data-id="China"]');
const JapanBtn = document.querySelector('[data-id="Japan"]');
...
// Show only menu items belonging to the category "Korea"
...
// Function: Display the specified menu items
function displayMenuItems(menuList) {
  // Ekrandaki içeriği temizle
  menuItemsContainer.innerHTML = '';

  // Let's use a loop to add menu items to the screen
